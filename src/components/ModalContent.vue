  ...
  <div class="modal" v-show="showModal">
    <form @submit="addMed" class="form-add">
      ...
      <div class="group-add">
        ...
        <div>
          <input v-model="nbrJour" type="text" class="input-add" id="nbrDeJours" required><br><br>
        </div>
      </div>
      <div class="group-add">
        <div class="text-add">
        ...
        <div>
          <input v-model="tauxJournalier" type="text" class="input-add" id="tauxJournalier" required><br><br>
        </div>
      </div>
      <div class="button-add">
        ...
        <button id="buttonCancel" @click="closeModal">
